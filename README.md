...
```
cd existing_repo
git remote add origin https://gitlab.com/onework/frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:517be2feabf66f43b83059149341a9d3?https://gitlab.com/onework/frontend/-/settings/integrations)
